    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            List<Aplicacion> listaApps = new List<Aplicacion>()
            {
                ...
                new AppMusica("Spotify", SistemaOperativo.ANDROID, 50, // Lo agrega con las canciones. 
                new List<string>()
                {
                ...
                new AppMusica("Spotify", SistemaOperativo.ANDROID, 50), // No lo debe agregar, repetido.
                new AppMusica("YouTube Music", SistemaOperativo.ANDROID, 30) // Lo debe agregar.
            };
